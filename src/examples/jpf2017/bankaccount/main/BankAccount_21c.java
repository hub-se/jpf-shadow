...
public class BankAccount_21c {
	...
	public BankAccount_21c(int amount) {
		balance = amount;
	}
	...
	public void withdraw(int amount) {
		...
		balance = balance - amount;
		numberOfWithdrawals = change(numberOfWithdrawals + 1, numberOfWithdrawals);
	}
	...
	public static void main(String[] args) {
		BankAccount_21c b = new BankAccount_21c(0);
		b.test(true, -1, 10);
	}
