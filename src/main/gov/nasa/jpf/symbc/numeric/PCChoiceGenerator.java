...
public class PCChoiceGenerator extends IntIntervalGenerator {	
	...
	//jpf-shadow: save execution mode in cg in order to restore it upon backtracking
	...
	protected ThreadInfo.Execute executionMode = Execute.BOTH;
	...
	public PCChoiceGenerator(int min, int max, int delta) {
		...
		isReverseOrder = (delta < 0 ? true : false);
	}
