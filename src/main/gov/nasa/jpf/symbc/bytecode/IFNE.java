...
/*
 * Implementation of the shadow symbolic IFNE bytecode instruction
 */
			...
			if(!ti.isFirstStepInsn()){
				...
				case 2: //Concrete execution	
					if(ti.getExecutionMode() == Execute.BOTH){
						...
						old_pc._addDet(Comparator.NE, shadow_v, 0);
						BytecodeUtils.addConcreteValues(old_pc);

						new_pc._addDet(Comparator.NE, sym_v, 0);						
						...
						next_pc._addDet(Comparator.NE, expr_v, 0);
						if(next_pc.simplify()){
