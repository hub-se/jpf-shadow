...
public class BytecodeUtils {
    ...
    public static InstructionOrSuper execute(JVMInvokeInstruction invInst, ThreadInfo th) {
        ...
        if (found) {
            ...
            if (!th.isFirstStepInsn()) { // first time around
                ...
                if (!(cg instanceof PCChoiceGenerator)) // the choice comes from
                                                        // super
            ...
            //jpf-shadow: map method parameters to concrete values (used for concrete execution)
            ...
            StackFrame sf = th.getModifiableTopFrame();// get a hold of the
                                                       // stack frame of the
                                                       // caller
    ...
    public static IntegerExpression getShadowExpr(Object expr, int concreteValue) {
        if (expr != null) {
            if (expr instanceof DiffExpression) {
    ...
    /*
     * public static IntegerExpression getSymbcExpr(Object expr, long
     * concreteValue); public static IntegerExpression getShadowExpr(Object
     * expr, long concreteValue); public static RealExpression
     * getSymbcExpr(Object expr, float concreteValue); public static
     * RealExpression getShadowExpr(Object expr, float concreteValue); public
     * static RealExpression getSymbcExpr(Object expr, double concreteValue);
     * public static RealExpression getShadowExpr(Object expr, double
     * concreteValue);
     */
    
    //jpf-shadow: add constraint variable = concreteValue to pc in order to force concrete execution
     ...
     * parameters of a change(boolean,boolean) invocation. This assumes that the
