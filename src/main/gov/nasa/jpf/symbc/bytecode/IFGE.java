...
/*
 * Implementation of the shadow symbolic IFGE bytecode instruction
 */
			...
			if(!ti.isFirstStepInsn()){
				...
				case 2: //Concrete execution	
					if(ti.getExecutionMode() == Execute.BOTH){
						...
						old_pc._addDet(Comparator.GE, shadow_v, 0);
						BytecodeUtils.addConcreteValues(old_pc);

						new_pc._addDet(Comparator.GE, sym_v, 0);						
						...
						next_pc._addDet(Comparator.GE, expr_v, 0);
