...
/*
 * Implementation of the shadow symbolic IFLE bytecode instruction
 */
			...
			if(!ti.isFirstStepInsn()){
				...
				case 2: //Concrete execution	
					if(ti.getExecutionMode() == Execute.BOTH){
						...
						old_pc._addDet(Comparator.LE, shadow_v, 0);
						BytecodeUtils.addConcreteValues(old_pc);

						new_pc._addDet(Comparator.LE, sym_v, 0);						
						...
						next_pc._addDet(Comparator.LE, expr_v, 0);
